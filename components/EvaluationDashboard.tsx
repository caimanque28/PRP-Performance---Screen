...
const FMS_ITEMS = [
  { id: 'deep_squat', label: 'Deep Squat', unilateral: false, category: 'Global' },
  { id: 'hurdle_step', label: 'Hurdle Step', unilateral: true, category: 'Global' },
  { id: 'inline_lunge', label: 'In-Line Lunge', unilateral: true, category: 'Global' },
  { id: 'shoulder_mobility', label: 'Shoulder Mobility', unilateral: true, category: 'Mobilidade' },
  { id: 'straight_leg_raise', label: 'Active Straight Leg Raise', unilateral: true, category: 'Mobilidade' },
  { id: 'trunk_stability', label: 'Trunk Stability Push-Up', unilateral: false, category: 'Estabilidade' },
  { id: 'rotary_stability', label: 'Rotary Stability', unilateral: true, category: 'Estabilidade' },
];
